...
def dns_response(data):
    ...
    reply.add_answer(RR(rname=qname, rtype=getattr(QTYPE, 'A'), rclass=1, ttl=TTL, rdata=A(IP)))
    #
    ...
    #                 if qt in ['*', rqt]:
    #                     reply.add_answer(RR(rname=qname, rtype=getattr(QTYPE, A), rclass=1, ttl=TTL, rdata=rdata))
    #
